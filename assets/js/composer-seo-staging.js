import { generateSitemapData, resolveSiteBaseUrl } from './seo.js?v=press-system-v3.4.50';
...
function buildDefaultIndexHtml(metaBlock, lang) {
  ...
  html += '  <script src="assets/js/theme-boot.js?v=press-system-v3.4.50"></script>\n';
  html += '  <link rel="stylesheet" id="theme-pack">\n';
  html += '</head>\n\n';
  html += '<body>\n';
  html += '  <script type="module" src="assets/main.js?v=press-system-v3.4.50"></script>\n';
  html += '</body>\n\n';
  html += '</html>\n';
  return html;
}
