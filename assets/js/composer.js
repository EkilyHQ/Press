...
import { t, getAvailableLangs, getLanguageLabel } from './i18n.js?v=press-system-v3.4.3';
import { generateSitemapData, resolveSiteBaseUrl } from './seo.js?v=press-system-v3.4.3';
import { initSystemUpdates, getSystemUpdateSummaryEntries, getSystemUpdateCommitFiles, clearSystemUpdateState } from './system-updates.js?v=press-system-v3.4.3';
import { initThemeManager, getThemeManagerSummaryEntries, getThemeManagerCommitFiles, clearThemeManagerState } from './theme-manager.js?v=press-system-v3.4.3';
import { buildEditorContentTree, findEditorContentTreeNode, flattenEditorContentTree } from './editor-content-tree.js?v=press-system-v3.4.3';
...
} from './encrypted-content.js?v=press-system-v3.4.3';
import {
...
} from './repository-deletions.js?v=press-system-v3.4.3';
...
function buildDefaultIndexHtml(metaBlock, lang) {
  ...
  html += '  <script src="assets/js/theme-boot.js?v=press-system-v3.4.3"></script>\n';
  html += '  <link rel="stylesheet" id="theme-pack">\n';
  html += '</head>\n\n';
  html += '<body>\n';
  html += '  <script type="module" src="assets/main.js?v=press-system-v3.4.3"></script>\n';
  html += '</body>\n\n';
  html += '</html>\n';
  return html;
}
