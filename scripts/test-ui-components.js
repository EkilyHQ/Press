...
assert.match(editorBlocks, /syncActiveTableAlignmentFromEditable\(activeBlock, editable \|\| state\.activeEditable \|\| runtime\.getActiveElement\(\)\);/, 'active block selection should sync table alignment from the focused table cell');
