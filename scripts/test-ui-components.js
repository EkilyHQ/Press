...
assert.match(main, /from '\.\/js\/theme-layout\.js\?v=theme-layout-generation-20260510';/, 'main should cache-bust theme layout when preview theme mount generation changes');
...
assert.match(editorPreviewRuntime, /from '\.\/theme-layout\.js\?v=theme-layout-generation-20260510';/, 'editor preview runtime should cache-bust theme layout generation changes');
