...
assert.match(indexEditorPreviewHtml, /<link rel="stylesheet" id="theme-pack">[\s\S]*editor-preview-runtime\.js\?v=editor-preview-theme-20260510/, 'editor preview iframe should own the theme-pack stylesheet and runtime');
