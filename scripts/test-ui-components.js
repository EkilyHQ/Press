...
assert.match(editorBlocks, /syncActiveTableAlignmentFromEditable\(activeBlock, editable \|\| state\.activeEditable \|\| document\.activeElement\);/, 'active block selection should sync table alignment from the focused table cell');
