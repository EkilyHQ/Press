...
assert.match(indexHtml, /src="assets\/main\.js\?v=katex-math-20260510"/, 'index should bump the main module URL when runtime imports change');
assert.match(composer, /src="assets\/main\.js\?v=katex-math-20260510"/, 'composer export template should use the same main module URL as index');
