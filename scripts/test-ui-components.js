...
assert.match(main, /from '\.\/js\/theme-layout\.js\?v=rich-index-metadata-20260512';/, 'main should cache-bust theme layout when preview theme mount generation changes');
assert.match(main, /from '\.\/js\/theme\.js\?v=rich-index-metadata-20260512';/, 'main should cache-bust theme helpers when local theme overlays change');
...
assert.match(main, /from '\.\/js\/i18n\.js\?v=rich-index-metadata-20260512';/, 'main should use the same versioned i18n module instance as shared UI modules');
...
assert.match(main, /from '\.\/js\/seo\.js\?v=rich-index-metadata-20260512';/, 'main should cache-bust SEO helpers after their i18n dependency changes');
assert.match(main, /from '\.\/js\/toc\.js\?v=rich-index-metadata-20260512';/, 'main should cache-bust TOC helpers after their i18n dependency changes');
assert.match(main, /from '\.\/js\/tags\.js\?v=rich-index-metadata-20260512';/, 'main should cache-bust tag helpers after their i18n dependency changes');
...
assert.match(composer, /from '\.\/theme-manager\.js\?v=rich-index-metadata-20260512';/, 'composer should cache-bust theme manager after Press engine compatibility changes');
...
assert.match(themeLayout, /from '\.\/i18n\.js\?v=rich-index-metadata-20260512';/, 'theme layout should share the repository deletion docs i18n cache key');
assert.match(languageManifest, /en\.js\?v=rich-index-metadata-20260512/, 'language manifest should cache-bust bundles when editor asset deletion strings change');
assert.doesNotMatch(
...
assert.match(themeLayout, /NATIVE_MODULE_CACHE_KEY = 'rich-index-metadata-20260512'/, 'theme layout should cache-bust native modules when shared i18n boundaries change');
assert.match(themeLayout, /from '\.\/theme\.js\?v=rich-index-metadata-20260512';/, 'theme layout should cache-bust theme helper imports');
...
assert.match(indexEditorHtml, /src="assets\/js\/editor-main\.js\?v=rich-index-metadata-20260512"/, 'editor should cache-bust runtime changes for default blocks view behavior');
...
assert.match(indexEditorPreviewHtml, /<link rel="stylesheet" id="theme-pack">[\s\S]*editor-preview-runtime\.js\?v=rich-index-metadata-20260512/, 'editor preview iframe should own the theme-pack stylesheet and runtime');
...
assert.match(editorPreviewRuntime, /from '\.\/theme-layout\.js\?v=rich-index-metadata-20260512';/, 'editor preview runtime should cache-bust theme layout generation changes');
...
assert.match(indexEditorHtml, /src="assets\/js\/editor-main\.js\?v=rich-index-metadata-20260512"/, 'editor should cache-bust editor-main after default blocks view changes');
assert.match(indexEditorHtml, /src="assets\/js\/composer\.js\?v=rich-index-metadata-20260512"/, 'editor should cache-bust composer after version compatibility changes');
...
assert.match(nativeInteractions, /from '\.\.\/\.\.\/\.\.\/js\/theme\.js\?v=rich-index-metadata-20260512'/, 'native interactions should cache-bust theme helper imports');
assert.match(nativeInteractions, /from '\.\.\/\.\.\/\.\.\/js\/tags\.js\?v=rich-index-metadata-20260512'/, 'native interactions should cache-bust tag helper imports');
assert.match(nativeInteractions, /from '\.\.\/\.\.\/\.\.\/js\/templates\.js\?v=rich-index-metadata-20260512'/, 'native interactions should cache-bust template helper imports');
assert.match(nativeInteractions, /from '\.\.\/\.\.\/\.\.\/js\/errors\.js\?v=rich-index-metadata-20260512'/, 'native interactions should cache-bust error helper imports');
assert.match(nativeInteractions, /from '\.\.\/\.\.\/\.\.\/js\/post-nav\.js\?v=rich-index-metadata-20260512'/, 'native interactions should cache-bust post navigation helper imports');
