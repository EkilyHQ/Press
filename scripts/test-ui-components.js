...
assert.match(editorMainPreviewSession, /previewThemeOverride[\s\S]*sanitizePreviewThemePack\(previewThemeSelect\.value/, 'editor preview theme selector should use a session-only override');
assert.match(editorMainPreviewSession, /assets\/themes\/packs\.local\.json', true/, 'editor preview selector should allow ignored local theme-pack overlays for development');
