...
assert.match(main, /from '\.\/js\/theme-layout\.js\?v=theme-layout-parallel-20260512';/, 'main should cache-bust theme layout when preview theme mount generation changes');
...
assert.match(indexHtml, /src="assets\/main\.js\?v=theme-layout-parallel-20260512"/, 'index should bump the main module URL when runtime imports change');
assert.match(composer, /src="assets\/main\.js\?v=theme-layout-parallel-20260512"/, 'composer export template should use the same main module URL as index');
...
assert.match(indexEditorPreviewHtml, /<link rel="stylesheet" id="theme-pack">[\s\S]*editor-preview-runtime\.js\?v=theme-layout-parallel-20260512/, 'editor preview iframe should own the theme-pack stylesheet and runtime');
...
assert.match(editorPreviewRuntime, /from '\.\/theme-layout\.js\?v=theme-layout-parallel-20260512';/, 'editor preview runtime should cache-bust theme layout generation changes');
