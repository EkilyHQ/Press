...
assert.match(main, /from '\.\/js\/theme-layout\.js\?v=editor-preview-theme-20260510';/, 'main should cache-bust theme layout when preview theme isolation changes');
assert.match(main, /from '\.\/js\/theme\.js\?v=local-theme-overlays-20260510';/, 'main should cache-bust theme helpers when local theme overlays change');
...
assert.match(themeLayout, /from '\.\/theme\.js\?v=local-theme-overlays-20260510';/, 'theme layout should cache-bust theme helper imports');
...
assert.match(indexHtml, /src="assets\/main\.js\?v=local-theme-overlays-20260510"/, 'index should bump the main module URL when runtime imports change');
assert.match(composer, /src="assets\/main\.js\?v=local-theme-overlays-20260510"/, 'composer export template should use the same main module URL as index');
...
assert.match(indexEditorHtml, /src="assets\/js\/editor-main\.js\?v=blocks-default-view-20260510"/, 'editor should cache-bust runtime changes for default blocks view behavior');
...
assert.match(indexEditorPreviewHtml, /<link rel="stylesheet" id="theme-pack">[\s\S]*editor-preview-runtime\.js\?v=editor-preview-stale-guard-20260510/, 'editor preview iframe should own the theme-pack stylesheet and runtime');
...
assert.match(nativeInteractions, /from '\.\.\/\.\.\/\.\.\/js\/theme\.js\?v=local-theme-overlays-20260510'/, 'native interactions should cache-bust theme helper imports');
