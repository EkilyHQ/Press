...
assert.match(indexEditorHtml, /src="assets\/js\/composer\.js\?v=frontmatter-merge-20260512"/, 'editor should cache-bust composer after version compatibility changes');
