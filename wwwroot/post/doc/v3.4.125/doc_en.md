...
tags:
  - Press
  - Documentation
excerpt: Current Press documentation for v3.4.125. Build a content site directly from Markdown and base YAML files, with current content-index formats, language fallback, themes, search, SEO, media, and deployment guidance.
author: Ekily
ai: true
---
...
> You can always fetch the v3.4.125 default settings from [v3.4.125/site.yaml](https://github.com/EkilyHQ/Press/blob/v3.4.125/site.yaml).
...
Legacy per-language sidecar files such as `index.en.yaml` or `tabs.en.yaml` are a migration source, not a current runtime fallback. If a site still uses them, update to Press v3.4.124 first, open the editor, publish the content-model migration, and then update to v3.4.125 or later.
